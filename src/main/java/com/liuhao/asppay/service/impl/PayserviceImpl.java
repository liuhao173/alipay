...
import com.liuhao.alipay.OrderCodeFactory;
...
public class PayserviceImpl implements PayService {
    ...
    public String unionPay(Product product) {
        ...
        requestData.put("signMethod", SDKConfig.getConfig().getSignMethod());//签名方法，只支持 01：RSA方式证书加密
        ...
        requestData.put("orderId", OrderCodeFactory.getOrderCode(null));//商户订单号，8-40位数字字母，不能含“-”或“_”，可以自行定制规则
